      ...
      >
        <div className="section-title mb-25">
          <span className="sub-title mb-5">
            the best empanadas on the market
          </span>
          <h2>Quality and Food Safety Certifications</h2>
        </div>
        <p>
          At Empalife, we ensure that our empanadas meet the highest standards
          of quality and food safety. We hold key certifications that allow us
          to distribute our products in supermarkets, restaurants, and major
